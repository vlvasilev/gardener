...
func (b *Botanist) DeleteDeprecatedCloudMetadataServiceNetworkPolicy() error {
	return b.DeleteChartSeed(filepath.Join(chartPathControlPlane, "deprecated-network-policies"), b.Shoot.SeedNamespace, "deprecated-network-policies")
}
